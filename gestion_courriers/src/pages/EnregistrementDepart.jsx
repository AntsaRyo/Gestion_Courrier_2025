...
const EnregistrementDepart = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log(ajouter);
      const response = await api.post('/ajouter_depart', ajouter);
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 overflow-y-auto h-[calc(100vh-64px)] relative">
          ...
          >
            ...
            {/* FORMULAIRE */}
            {errors &&
            <div className="alert alert-danger text-red-500 mx-2">Veuillez remplir tous les champs</div>}
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  type="text"
                  value={ajouter.DestinataireDepart}
                  onChange={handleChange}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  value={ajouter.numero_correspondance_depart}
                  onChange={handleChange}
                  className={`px-3 py-2 rounded-lg border ${
                    darkMode
                      ? "bg-gray-700 border-gray-600 text-gray-100"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  type="date"
                  value={ajouter.DateCorrespondanceDepart}
                  onChange={handleChange}
                  className={`px-3 py-2 rounded-lg border ${
                    darkMode
                      ? "bg-gray-700 border-gray-600 text-gray-100"
              ...
              <div className="flex flex-col">
                <label className="text-xl font-semibold mb-1">Observations</label>
                <input
                  name="ObservationsDepart"
                  type="text"
                  value={ajouter.ObservationsDepart}
                  onChange={handleChange}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  value={ajouter.nombre_pieces_jointes}
                  onChange={handleChange}
