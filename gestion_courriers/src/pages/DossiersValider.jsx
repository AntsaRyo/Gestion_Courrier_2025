...
const DossiersValider = () => {
  ...
  const currentPage = "Dossiers à valider";
  ...
  const filtre = React.useMemo(() => {
    ...
    return courriers.filter((e) => {
      ...
      // corrige l'orthographe si nécessaire : TexteCorrespondanceArrive
        const ObjetDepart = normalize(e.ObjetDepart).toLowerCase();
  ...
  }, [courriers, filterDestinataire, filterNumeroCorr, filterObjetDepart, filterDateCorrespondanceDepart]);
  ...
  const cliquer = async () => {
    ...
    try {
      await api.post(`/valider/${selectedNumero}`);
            ...
            {/* MES DOSSIERS */}
              <div>
                ...
                <ul className="space-y-2 mt-1">
                  ...
                  <li
                    className={`p-2 rounded-md cursor-pointer flex items-center gap-2 font-medium transition ${
                      currentPage === "Dossiers à valider"
                        ? darkMode
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50">
            ...
            >
              ...
              <p className="text-gray-500 mb-6">
                Voulez-vous valider le dossier N° <strong>{selectedNumero}</strong> ?
              </p>
  ...
  />
          ...
          >
            ...
            >
              ...
              >
                Listes des courriers à valider
              </h2>
              <p className="text-sm text-gray-500 mt-1">
                Nombre de courrier. ({filtre.length})
              </p>
              <p className="flex text-sm text-gray-500 mt-1">
                Cliquez sur l'icône  <CheckCircle size={25} className="mx-2" />  pour valider un courrier.
              </p>
            </div>
              ...
              <table className="min-w-full border-collapse">
                <thead>
                  ...
                  >
                    ...
                    <th className="px-4 py-3 text-center text-sm">État</th>
                  ...
                  {filtre.length === 0 ? (
                    ...
                    filtre.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center text-sm whitespace-normal break-words w-55">{item.DestinataireDepart}</td>
                        ...
                        <td className="px-4 py-3 text-center text-sm whitespace-normal break-words w-40">{item.ObjetDepart}</td>
                        <td className="px-4 py-3 text-center text-sm whitespace-normal break-words w-40">{item.ObservationsDepart}</td>
...
export default DossiersValider;
