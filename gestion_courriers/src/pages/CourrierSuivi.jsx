...
const CourrierSuivi = () => {
  ...
  useEffect(() => {
    api.get(`/CourrierSuivi/${encodeURIComponent(nomDivision)}`)
      .then((res) => {
  ...
  const cliquer = async () => {
    ...
    try {
      await api.post(`/archiver/${selectedNumero}`);
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50">
            ...
            >
              ...
              <p className="text-gray-500 mb-6">
                Voulez-vous archiver ce dossier comme traité ?
              </p>
              ...
              <div className="flex justify-center gap-4">
                ...
                <button
                  onClick={cliquer}
                  className="px-6 py-2 rounded-lg bg-purple-600 hover:bg-green-700 text-white transition"
                >
                  Valider
                </button>
              </div>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">
                Cliquez sur l'icône  <Archive size={23} className="mx-2" />  pour archiver un courrier.
              </p>
            </div>
