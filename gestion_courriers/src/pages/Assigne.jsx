...
const Informations = () => {
  ...
  const currentPage = "Courriers à dispatcher";
  ...
  const cliquer = async () => {
    ...
    try {
      await api.post(`/assignation/${selectedNumero}`);
      setCourriers((prev) => prev.filter((c) => c.NumeroArrive !== selectedNumero));
      setModalOpen(false);
    } catch (error) {
            ...
            {/* MES DOSSIERS */}
              <div>
                ...
                <ul className="space-y-2 mt-1">
                  ...
                  <li
                    className={`p-2 rounded-md cursor-pointer flex items-center gap-2 font-medium transition ${
                      currentPage === "Courriers à dispatcher"
                      ? darkMode
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">
                Cliquez sur l'icône  <Send size={23} className="mx-2" />  pour envoyé le courrier.
              </p>
            </div>
              ...
              <table className="min-w-full border-collapse">
                <thead>
                  ...
                  >
                    ...
                    <th className="px-4 py-3 text-center text-sm w-36">Action</th>
                  </tr>
                </thead>
                  ...
                  {filtre.length === 0 ? (
                    ...
                    filtre.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center text-sm">{formatDate(item.DateArrive)}</td>
                        ...
                        <td className="px-4 py-3 text-center text-sm">{item.TexteCorespondanceArrive}</td>
                        <td className="px-4 py-3 text-center text-sm">{item.Destinataire}</td>
                        <td className="px-4 py-3 text-center text-sm">{item.observations}</td>
                        ...
                        <td className="px-4 py-3 text-center">
                          <div className="flex items-center justify-center gap-3">
                              <button
                                onClick={() => {
                                  setSelectedNumero(item.NumeroArrive);
                                  setModalOpen(true);
                                }}
